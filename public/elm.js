...
{
	if (region.W.C === region.ad.C)
	{
		return 'on line ' + region.W.C;
	}
	return 'on lines ' + region.W.C + ' through ' + region.ad.C;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { aV: 'hidden', aI: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { aV: 'mozHidden', aI: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { aV: 'msHidden', aI: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { aV: 'webkitHidden', aI: 'webkitvisibilitychange' }
		: { aV: 'hidden', aI: 'visibilitychange' };
}
...
var avh4$elm_color$Color$fromHsla = function (_n0) {
	var hue = _n0.ah;
	var saturation = _n0.ax;
	var lightness = _n0.aj;
	var alpha = _n0.aE;
...
var avh4$elm_color$Color$toHsla = function (_n0) {
	...
	return {aE: a, ah: h3, aj: l, ax: s};
};
var author$project$Render$Utils$lighterColor = function (color) {
...
var author$project$Objects$Planet$mkPlanet = F4(
	function (center, r, m, color) {
		var wave = {
			aH: center,
			M: author$project$Render$Utils$lighterColor(color),
			aK: r,
			aM: 1500,
			a1: 2.5 * r,
			a2: r
		};
		return {aH: center, M: color, ak: m, U: r, J: wave};
	});
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {af: fragment, ag: host, an: path, aq: port_, at: protocol, au: query};
	});
	...
	return _Utils_Tuple2(
		{
			...
			D: _List_fromArray(
				[
					A4(
					author$project$Objects$Planet$mkPlanet,
					{K: -100, L: 100},
					50,
					100,
				...
				switch (setting.$) {
					case 0:
						...
						return _Utils_update(
							r,
							{
								k: A2(elm$core$List$cons, cmd, r.k)
							});
					case 1:
						var cmds = setting.a;
						return _Utils_update(
							r,
							{
								k: A3(elm$core$List$foldl, elm$core$List$cons, r.k, cmds)
							});
					case 3:
						var f = setting.a;
						return _Utils_update(
					...
					default:
						...
						return _Utils_update(
							r,
							{
								s: A2(joakin$elm_canvas$Canvas$mergeDrawOp, r.s, op)
							});
				}
			});
...
var joakin$elm_canvas$Canvas$shapes = F2(
	function (settings, ss) {
		return A2(
			...
			{
				k: _List_Nil,
				s: joakin$elm_canvas$Canvas$Internal$Canvas$NotSpecified,
				t: joakin$elm_canvas$Canvas$Internal$Canvas$DrawableShapes(ss)
			});
	});
...
var author$project$Main$clearScreen = F2(
...
var author$project$Render$Painter$rectRange = F4(
	function (center, w, h, v) {
		var dy = elm$core$Basics$abs(v.aH.L - center.L);
		var dx = elm$core$Basics$abs(v.aH.K - center.K);
		return (_Utils_cmp(dx, (w + v.A) / 2) < 0) && (_Utils_cmp(dy, (h + v.v) / 2) < 0);
	});
var avh4$elm_color$Color$fromRgba = function (components) {
	return A4(avh4$elm_color$Color$RgbaSpace, components.V, components.P, components.O, components.aE);
};
var avh4$elm_color$Color$toRgba = function (_n0) {
	...
	var b = _n0.c;
	var a = _n0.d;
	return {aE: a, O: b, P: g, V: r};
};
var author$project$Render$Utils$changeAlpha = F2(
	function (alpha, c) {
...
var author$project$Render$Painter$PaintShape = function (a) {
	return {$: 0, a: a};
};
var author$project$Render$Painter$PainterDraw = F2(
	function (settings, actions) {
		return {Z: actions, N: settings};
	});
...
var author$project$Render$Utils$drawCircle = F3(
	function (_n0, r, color) {
		var x = _n0.K;
		var y = _n0.L;
		return A2(
			author$project$Render$Painter$PainterDraw,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					author$project$Render$Painter$PaintShape(
					A2(
...
var author$project$Objects$Wave$paintWave = function (_n0) {
	var center = _n0.aH;
	var minR = _n0.a2;
	var maxR = _n0.a1;
	var currentR = _n0.aK;
	var color = _n0.M;
	var duration = _n0.aM;
	var stage = (currentR - minR) / (maxR - currentR);
	var newColor = A2(author$project$Render$Utils$changeAlpha, 1.0 - stage, color);
	var draw = A3(
		author$project$Render$Utils$drawCircle,
		{K: 0, L: 0},
		currentR,
		newColor);
	return elm$core$List$singleton(
		{
			aH: center,
			aL: draw,
			a7: A3(author$project$Render$Painter$rectRange, center, maxR * 2, maxR * 2)
		});
};
var author$project$Objects$Planet$paintPlanet = function (_n0) {
	var wave = _n0.J;
	var center = _n0.aH;
	var r = _n0.U;
	var color = _n0.M;
	var renderPlanet = A3(
		...
		color);
	return _Utils_ap(
		author$project$Objects$Wave$paintWave(wave),
		_List_fromArray(
			[
				{
				aH: center,
				aL: renderPlanet,
				a7: A3(author$project$Render$Painter$rectRange, center, r * 2, r * 2)
			}
			]));
};
...
var author$project$Render$Painter$getTransforms = F2(
	function (v, _n0) {
		var x = _n0.K;
		var y = _n0.L;
		var dy = y - v.aH.L;
		...
		return _List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2(joakin$elm_canvas$Canvas$Settings$Advanced$translate, realX, realY)
					]))
			]);
	});
	...
	function (settings, point, str) {
		return A2(
			...
			settings,
			{
				k: _List_Nil,
				s: joakin$elm_canvas$Canvas$Internal$Canvas$NotSpecified,
				t: joakin$elm_canvas$Canvas$Internal$Canvas$DrawableText(
					{Q: elm$core$Maybe$Nothing, ap: point, Y: str})
			});
	});
var author$project$Render$Painter$renderAction = F2(
	function (st, act) {
		if (!act.$) {
			var shape = act.a;
			return A2(
			...
			return A3(
				...
				st,
				_Utils_Tuple2(pos.K, pos.L),
				str);
		}
	});
var author$project$Render$Painter$renderDraw = function (_n0) {
	var settings = _n0.N;
	var actions = _n0.Z;
	return A2(
		elm$core$List$map,
		author$project$Render$Painter$renderAction(settings),
		actions);
};
var author$project$Render$Painter$wrapDraw = F2(
	function (st, painter) {
		return _Utils_update(
			painter,
			{
				N: _Utils_ap(st, painter.N)
			});
	});
...
var author$project$Render$Painter$runPainter = F2(
	function (v, painter) {
		return painter.a7(v) ? A3(
			elm$core$Basics$composeR,
			author$project$Render$Painter$wrapDraw(
				A2(author$project$Render$Painter$getTransforms, v, painter.aH)),
			author$project$Render$Painter$renderDraw,
			painter.aL) : _List_Nil;
	});
...
var author$project$Render$Painter$runPainters = function (v) {
	return A2(
		elm$core$Basics$composeR,
		elm$core$List$map(
			author$project$Render$Painter$runPainter(v)),
...
var joakin$elm_canvas$Canvas$renderTextFill = F5(
	function (txt, x, y, color, cmds) {
		return A2(
			elm$core$List$cons,
			A4(joakin$elm_canvas$Canvas$Internal$CustomElementJsonApi$fillText, txt.Y, x, y, txt.Q),
			A2(
				elm$core$List$cons,
...
var joakin$elm_canvas$Canvas$renderTextStroke = F5(
	function (txt, x, y, color, cmds) {
		return A2(
			elm$core$List$cons,
			A4(joakin$elm_canvas$Canvas$Internal$CustomElementJsonApi$strokeText, txt.Y, x, y, txt.Q),
			A2(
				elm$core$List$cons,
	...
	function (x, y, t, cmds) {
		return A2(
			...
			function () {
				if (!t.$) {
					var image = t.a;
					return A9(joakin$elm_canvas$Canvas$Internal$CustomElementJsonApi$drawImage, 0, 0, image.A, image.v, x, y, image.A, image.v, image.aY);
				} else {
					var sprite = t.a;
					var image = t.b;
					return A9(joakin$elm_canvas$Canvas$Internal$CustomElementJsonApi$drawImage, sprite.K, sprite.L, sprite.A, sprite.v, x, y, sprite.A, sprite.v, image.aY);
				}
			}(),
			cmds);
	});
...
var joakin$elm_canvas$Canvas$decodeTextureImageInfo = A2(
	...
	function (target) {
		return A3(
			...
			F2(
				function (width, height) {
					return {v: height, aY: target, A: width};
				}),
			A2(
	...
	function (options, attrs, entities) {
		return A3(
			...
			A2(
				...
				A2(
					elm$core$List$cons,
					elm$html$Html$Attributes$height(options.v),
					A2(
						elm$core$List$cons,
			...
			A2(
				...
				A2(elm$core$List$map, joakin$elm_canvas$Canvas$renderTextureSource, options.aB)));
	});
		...
		_List_fromArray(
			[
				...
				_Utils_ap(
					_List_fromArray(
						[
							A2(author$project$Main$clearScreen, width, height)
						]),
					A2(
						author$project$Render$Painter$runPainters,
						{
							aH: {K: 0, L: 0},
							v: height,
							A: width
						...
						A3(
							elm$core$Basics$composeR,
							elm$core$List$map(author$project$Objects$Planet$paintPlanet),
							elm$core$List$concat,
							planet))))
			]));
};
var author$project$Objects$Wave$mod = F2(
	function (x, y) {
		return x - (elm$core$Basics$floor(x / y) * y);
	});
var author$project$Objects$Wave$updateWave = F2(
	function (t, wave) {
		return _Utils_update(
			wave,
			{
				aK: wave.a2 + A2(author$project$Objects$Wave$mod, (wave.aK + ((t / wave.aM) * (wave.a1 - wave.a2))) - wave.a2, wave.a1 - wave.a2)
			});
	});
var author$project$Objects$Planet$updatePlanet = F2(
	function (t, pl) {
		return _Utils_update(
			pl,
			{
				J: A2(author$project$Objects$Wave$updateWave, t, pl.J)
			});
	});
...
var elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {S: oldTime, aw: request, az: subs};
	});
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								D: A2(
									elm$core$List$map,
									author$project$Objects$Planet$updatePlanet(delta),
									model.D)
							}),
